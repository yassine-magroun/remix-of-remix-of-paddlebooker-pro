...
const translations = {
  en: {
    ...
    pricingDesc: "Real sessions, real prices — in Tunisian Dinar (TND).",
    mostPopular: "Most Popular",
    perPerson: "per person",
    extraHour: "extra hour",
    depositNote: "A 40% deposit is required to confirm your booking. Remaining balance payable on-site.",
  ...
  fr: {
    ...
    pricingDesc: "De vraies sessions, de vrais prix — en dinars tunisiens (TND).",
    mostPopular: "Le plus populaire",
    perPerson: "par personne",
    extraHour: "heure supplémentaire",
    depositNote: "Un acompte de 40 % est requis pour confirmer votre réservation. Le solde est à payer sur place.",
